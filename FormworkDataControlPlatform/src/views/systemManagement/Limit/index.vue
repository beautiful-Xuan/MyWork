      ...
      <div class="widthSet">
        ...
        <div class="table_box border">
            <div class="i_title"><i class="el-icon-document" style="font-size:20px;"></i> 
               ...
               <el-button class="addLimit" @click="addLimit()" size="mini" autofocus>添加权限组</el-button>
            </div>
            <div class="table_body">
                <el-table
                  ...
                  <template slot-scope="scope">
                      <el-button @click="setLimit(scope.$index,scope.row)" type="text" size="small">维护权限</el-button>
